    ...
    <div className="min-h-screen text-[var(--text-primary)] flex flex-col justify-between max-w-md mx-auto select-none relative pb-20 border-x border-[var(--border-color)] bg-[var(--bg-primary)] transition-colors">
      ...
      <main className="p-4 space-y-5 flex-1">
        ...
        <section className="space-y-3">
          <h2 className="text-xs font-bold text-[var(--text-primary)] px-0.5 uppercase tracking-wider">Atalhos Rápidos</h2>
        ...
        <section className="space-y-3 pt-1">
          <div className="flex justify-between items-center px-0.5">
            <h2 className="text-xs font-bold text-[var(--text-primary)] uppercase tracking-wider">Auditorias Recentes</h2>
            <button
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-1 pt-1">
                    ...
                    <div className="flex justify-between text-[11px] font-medium text-[var(--text-dim)] pt-0.5 uppercase tracking-tighter">
                      <span>Progresso</span>
                      <span>{progressPct}% ({stats.foundCount}/{stats.totalExpected})</span>
                    </div>
                  </div>
                </div>
              );
      ...
      <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-[var(--bg-secondary)] border-t border-[var(--border-color)] h-16 px-3 flex items-center justify-around z-50 shadow-lg transition-colors">
        ...
        >
          ...
          <span className="text-[10px] font-black uppercase tracking-tighter mt-0.5">Dashboard</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] font-bold mt-0.5">Inventário</span>
        </button>
        ...
        >
          <QrCode className="w-5 h-5" />
          <span className="text-[10px] font-bold mt-0.5">Importar</span>
        </button>
