        ...
        {csvFileName && csvParsedItems.length > 0 && (
          <div className="fixed inset-x-6 bottom-20 z-40 bg-[var(--bg-secondary)] border-2 border-sky-500/30 rounded-3xl p-6 space-y-4 shadow-2xl max-h-[75vh] overflow-y-auto">
             <div className="flex flex-col items-center text-center gap-2">
                 ...
                 <span className="text-xs font-bold bg-[var(--btn-primary-bg)] text-white px-4 py-1 rounded-full uppercase tracking-wider">
             ...
             <button onClick={handleConfirmImport} className="w-full py-4 bg-[var(--btn-primary-bg)] hover:opacity-90 text-white rounded-2xl font-bold text-xs uppercase tracking-wider shadow-md active:scale-95 transition-all">Confirmar e Abrir</button>
