      ...
      <main className="py-6 space-y-6 flex-1 overflow-hidden flex flex-col">
        ...
        {logs.length === 0 ? (
          ...
          <div className="space-y-4 overflow-y-auto flex-1 pr-1 custom-scrollbar">
            {logs.map((log: any) => (
              <div key={log.id} className="relative pl-8 before:content-[''] before:absolute before:left-[11px] before:top-8 before:bottom-[-16px] before:w-[2px] before:bg-[var(--text-dim)]/20 last:before:hidden">
                <div className="absolute left-0 top-1.5 w-6 h-6 rounded-full bg-[var(--bg-secondary)] border-2 border-[var(--border-color)] flex items-center justify-center z-10 shadow-sm">
